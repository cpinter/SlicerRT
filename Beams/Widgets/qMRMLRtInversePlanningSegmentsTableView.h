...
#ifndef __qMRMLRtInversePlanningSegmentsTableView_h
#define __qMRMLRtInversePlanningSegmentsTableView_h
...
class qMRMLRtInversePlanningSegmentsTableViewPrivate;
...
class Q_SLICER_MODULE_BEAMS_WIDGETS_EXPORT qMRMLRtInversePlanningSegmentsTableView : public qMRMLWidget
{
  Q_OBJECT
  QVTK_OBJECT
...
public:
  ...
  /// Constructor
  explicit qMRMLRtInversePlanningSegmentsTableView(QWidget* parent = nullptr);
  /// Destructor
  ~qMRMLRtInversePlanningSegmentsTableView() override;
...
protected:
  QScopedPointer<qMRMLRtInversePlanningSegmentsTableViewPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qMRMLRtInversePlanningSegmentsTableView);
  Q_DISABLE_COPY(qMRMLRtInversePlanningSegmentsTableView);
};
