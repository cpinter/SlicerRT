...
#ifndef __qMRMLRtInversePlanningSegmentsModel_h
#define __qMRMLRtInversePlanningSegmentsModel_h
...
class qMRMLRtInversePlanningSegmentsModelPrivate;
...
class Q_SLICER_MODULE_SEGMENTATIONS_WIDGETS_EXPORT qMRMLRtInversePlanningSegmentsModel : public QStandardItemModel
{
  Q_OBJECT
  QVTK_OBJECT
  ...
  /// Control in which column the segment color is displayed (qMRMLRtInversePlanningSegmentsModel::VisibilityRole).
  /// A value of -1 (default) hides the column
  ...
  /// Control in which column the segment layer is displayed (qMRMLRtInversePlanningSegmentsModel::LayerRole).
...
public:
  ...
  qMRMLRtInversePlanningSegmentsModel(QObject *parent=nullptr);
  ~qMRMLRtInversePlanningSegmentsModel() override;
...
protected:
  qMRMLRtInversePlanningSegmentsModel(qMRMLRtInversePlanningSegmentsModelPrivate* pimpl, QObject *parent=nullptr);
...
protected:
  QScopedPointer<qMRMLRtInversePlanningSegmentsModelPrivate> d_ptr;

private:
  Q_DECLARE_PRIVATE(qMRMLRtInversePlanningSegmentsModel);
  Q_DISABLE_COPY(qMRMLRtInversePlanningSegmentsModel);
};
